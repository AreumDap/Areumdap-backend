...
import com.umc9th.areumdap.domain.question.service.UserQuestionCommandService;
import com.umc9th.areumdap.domain.question.service.UserQuestionQueryService;
...
public class UserQuestionController implements UserQuestionControllerDocs {
    ...
    public ResponseEntity<ApiResponse<Void>> saveQuestion(
        ...
        return ApiResponse.success(SuccessStatus.CREATE_QUESTION_SUCCESS);
    }
