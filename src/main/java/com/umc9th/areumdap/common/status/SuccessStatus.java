...
public enum SuccessStatus implements BaseStatus {
    ...
    UPDATE_HISTORY_SUMMARY_SUCCESS(HttpStatus.OK, "CHAR_200", "성장 히스토리 업데이트 성공"),
    ...
    DELETE_MISSION_SUCCESS(HttpStatus.OK,"MISSION_200","미션 삭제 성공"),


    /**
     * ChatBot
     */
    GET_CHATBOT_RECOMMEND_SUCCESS(HttpStatus.OK, "CHATBOT_200", "AI 대화 질문 배정 성공"),
    GET_ASSIGNED_QUESTION_SUCCESS(HttpStatus.OK, "CHATBOT_200", "배정된 질문 조회 성공"),
    ...
    CREATE_CHAT_REPORT_SUCCESS(HttpStatus.CREATED, "REPORT_201", "채팅 레포트 생성 성공");
